...
export class InvoiceService {
    ...
    search(search : InvoiceSearch): Observable<Invoice[]> {
        if (search.mobile) {
            ...
            return of(this.mockInvoice.filter(i => i.ticket === search.ticketCreation));
        }
        return null;
    }
